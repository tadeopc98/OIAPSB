...
import './ComprasPublicas.css'; // Importamos los estilos CSS que son específicos para este componente
...
const EstadosFinancieros = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:3001/api/pdfsComprasPublicas')  // Cambia esta URL si es necesario
    ...
    <div className="estatutos-sidebars-container">
        ...
        <div className="estatutos-sidebar">
            <h5 className='estatutos-list-title'>Compras Públicas en archivos PDF por fecha</h5>
            <ul>
                {pdfs.map((pdf) => (
                    <li 
                        key={pdf.id} 
